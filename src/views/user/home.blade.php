                        ...
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <a href="about.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read
                                    More</a>
                                <a href="courses.php"
                                    class="btn btn-light py-md-3 px-md-5 animated slideInRight">Explore</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="<?= asset('img/user/about.jpg') ?>"
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                @foreach ($data['categories'] as $category)
                    @php
                        extract($category);
                    @endphp
                    <a href="/course/category/{{ $id }}" rel="noopener noreferrer"
                        class="text-decoration-none">
                        <div class="col mx-2">
                            <div class="card h-100" style="border: none">
                                <img src="{{ asset('img/categories/' . $thumbnail) }}" class="card-img-top rounded"
                                    height="170px">
