                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-sm-10 col-lg-8">
                            ...
                            <a href="courses.php" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Explore</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            foreach ($categories as $category) :
                extract($category);
            ?>
                <a href="/course/category/<?= $id ?>" rel="noopener noreferrer" class="text-decoration-none">
                    <div class="col mx-2">
