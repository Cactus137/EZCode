...
<div class="container-xxl p-0 mb-5">
    ...
    ?>
        <div class="container p-0">
            <div class="background-detail-course" style="  background-image: url('<?= asset('img/courses/bg-course.jpg') ?>') !important;">
                <div class="row">
                        ...
                        <div class="detail-course">
                            <div class="row">
                                <div class="course_price mb-4 d-flex justify-content-center align-items-center text-light fs-3">
                                    Price: <span class="price_after me-2 text-success fs-3 ms-3">$<?= $price ?></span>
                                </div>
                            </div>
                            <div class="row">
                                <a href="/payment/<?= $id ?>" class="btn btn-primary m-0 py-2 btn-lg rounded-pill">Join now</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        ?>
                            <div class="row d-flex mb-4">
                                <div class="col-1 avatar-account">
                                    <img class="rounded-circle" src="<?= asset('img/accounts/' . $account['avatar'] )?>" alt="" width="60px">
                                </div>
                                <div class="col-9 bg-content">
                                    <div class="row d-flex">
                                        <p><span class="fw-bold"><?= $account['username'] ?></span><span class="m-0 py-0 px-2">|</span><span><?= $created_at ?></span></p>
                                    </div>
                                    <div class="row">
                                        <p><?= $comment  ?></p>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-2 mx-3 p-0">
                                    <a href="/course/<?= $related_course['id'] ?>" class="text-decoration-none">
                                        <img class="border" src="<?= asset('img/courses/' . $related_course['thumbnail']) ?>" width="100%">
                                    </a>
                                </div>
                                <div class="col-9">
                                    <div class="row">
                                        <div class="col-9">
                                            ...
                                            <div class="row">
                                                <p class="course_author_name m-0 text-secondary fs-6"><?= $related_course['author'] ?></p>
                                            </div>
                                            <div class="row">
                                                <p><?= $title ?></p>
                                            </div>
                                            <div class="row">
                                                <div class="rating d-flex">
                                                    <p class="percent my-0 me-2 p-0"><?= $related_course['rating'] ?></p>
                                                    <?php
                                                    for ($j = 0; $j < 5; $j++) :
                                                    ?>
                                                        <svg class="mt-1" xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512">
                                                    ...
                                                    <?php endfor; ?>
                                                    <p class="number-rating my-0 ms-2 p-0">(<?= $related_course['number_of_participants'] ?>)</p>
                                                </div>
                                            </div>
                                        </div>
