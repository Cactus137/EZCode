                    ...
                    <td>
                      <div class="btn-list flex-nowrap d-flex justify-content-center">
                        <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                          <a href="#" class="btn btn-vk w-100 btn-icon" data-bs-toggle="modal" data-bs-target="#modal-scrollable">
                        ...
                        <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                          <a href="#" class="btn btn-twitter w-100 btn-icon" aria-label="Youtube" data-bs-toggle="modal" data-bs-target="#modal-report1">
                        ...
                        <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                          <a href="#" class="btn btn-pinterest w-100 btn-icon" data-bs-toggle="modal" data-bs-target="#modal-danger">
