<div class="page-wrapper">
  ...
  if (isset($_SESSION['notify-account'])) {
    echo '<div class="position-absolute end-0 mt-5">
                <div class="alert alert-' . $_SESSION['notify-account'][1] . ' alert-dismissible" role="alert" style="width: 300px;">
                  <div class="d-flex">
                    <div>'
      . $_SESSION['notify-account'][2] .
      '</div>
                  </div>
                    ...
                    <tr>
                      <td data-label="Name">
                        <div class="d-flex py-1 align-items-center">
                          <span class="avatar me-2" style="background-image: url('<?= asset('img/accounts/' . $avatar) ?>')"></span>
                          <div class="flex-fill">
                      ...
                      <td>
                        <div class="btn-list flex-nowrap d-flex justify-content-center">
                          <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                            <a href="#" class="btn btn-twitter w-100 btn-icon" data-bs-toggle="modal" data-bs-target="#modal-update" data-account-id="<?= $id ?>">
                              <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                          </div>
                          <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                            <a href="#" class="btn btn-pinterest w-100 btn-icon" aria-label="Youtube" data-bs-toggle="modal" data-bs-target="#modal-delete" data-account-id="<?= $id ?>">
                ...
                <div class="mb-3">
                  ...
                  <div>
                    <label class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" value="0" name="role-add" checked>
                      <span class="form-check-label">Client</span>
                    </label>
                    <label class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" value="1" name="role-add">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <div>
                    <label class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" value="0" name="role-update">
                      <span class="form-check-label">Client</span>
                    </label>
                    <label class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" value="1" name="role-update">
                      <span class="form-check-label">Admin</span>
                    </label>
                  </div>
                </div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="/admin/account/delete-account" method="post">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
            <button type="submit" name="btn-delete-account" class="btn btn-primary">Delete Account</button>
          </div>
        </form>
      </div>
    </div>
