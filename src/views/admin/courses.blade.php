    ...
    <div class="page-wrapper">
        @if (isset($_SESSION['notify-course']))
            <div class="position-absolute end-0 mt-5">
                <div id="alert-notify" class="alert alert-{{ $_SESSION['notify-course'][1] }} alert-dismissible" role="alert"
                    style="width: 300px;">
                    <div class="d-flex">
                        <div>{{ $_SESSION['notify-course'][2] }}</div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <span class="avatar me-2"
                                                    style="background-image: url('{{ asset('img/courses/' . $thumbnail) }}')"></span>
                                            </td>
                                            <td>{{ $name }}</td>
                                            <td>{{ $price }}</td>
                                            <td>{{ $created_at }}</td>
                                            <td class="sort-status text-center">
                                                <div class="col-auto"><span
                                                        class="badge bg-{{ $status == 1 ? 'red' : 'green' }} me-2"></span>{{ $status == 1 ? 'Hidden' : 'Public' }}
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-list flex-nowrap d-flex justify-content-center">
                                                    <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                                                        <a href="#" class="btn btn-vk w-100 btn-icon"
                    ...
                    <form action="/admin/course/add-course" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="price-add"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="author-add"
                            ...
                            <div class="mb-3 mb-0">
                                ...
                                <textarea rows="5" class="form-control" name="description-add" placeholder="Here can be course description"
                                    value=""></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <label class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="0" name="status-add"
                                            checked>
        ...
        <div class="modal modal-blur fade" id="modal-update" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label class="form-label">Price</label>
                                        <input type="text" class="form-control" name="price-update"
                                            placeholder="Price Course">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label class="form-label">Author</label>
                                        <input type="text" class="form-control" name="author-update"
                                            placeholder="Author Course">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Title</label>
                                <input type="text" class="form-control" name="title-update"
                                    placeholder="Title Course">
                            </div>
                            <div class="mb-3 mb-0">
                                <label class="form-label">Description</label>
                                <textarea rows="5" class="form-control" name="description-update" placeholder="Here can be course description"
                                    value=""></textarea>
                            </div>
                            <div class="mb-3">
                                <div class="form-label">Category</div>
                ...
                ?>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" name="btn-update-course" class="btn btn-primary">Update
                                Course</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="/admin/course/delete-course" method="post">
                        <div class="modal-body text-center py-4">
                            ...
                            <h3>Are you sure?</h3>
                            <div class="text-secondary">Do you really want to remove this course? What you've done cannot
                                be undone.</div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" name="btn-delete-course" class="btn btn-primary">Delete
                                Course</button>
                        </div>
                    </form>
                </div>
