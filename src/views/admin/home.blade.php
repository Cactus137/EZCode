...
@section('content')
                                        ...
                                        <div class="divide-y">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <span class="avatar"
                                                            style="background-image: url({{ asset('img/accounts/profile.jpg')}})"></span>
                                                    </div>
                                                    <div class="col">
                                                        <div class="text-truncate">
                            ...
                            <div class="card-table table-responsive">
                                <table class="table table-vcenter">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="w-1">
                                                <span class="avatar avatar-sm" style="background-image: url({{ asset('img/accounts/profile.jpg')}}>
    ...
    <script src="{{ asset('libs/jsvectormap/dist/maps/world.js') }}l" defer></script>
